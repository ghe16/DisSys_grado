...
public class SensorClient {
    ...
    public static void main(String[] args) {
        try {
            ...
            //client.publish(STATUS_TOPIC, "Sensor online".getBytes(), 1, true);
            ...
            while (true) {
                ...
                client.publish(TEMPERATURE_TOPIC, temperatureMessage.getBytes(), 1, true);
                System.out.println("Published temperature: " + temperatureMessage);

                // Publish alert if temperature is above threshold
                if (temperature > 30) {
                    String alertMessage = "Overheating! " + temperatureMessage + "°C";
                    client.publish(ALERT_TOPIC, alertMessage.getBytes(), 0, false);
